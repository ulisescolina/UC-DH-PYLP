<?php
class ci_inasistencias extends nominas_ci
{
    ...
    function get_licencias_trabajadores($id) {
        $this->get_relacion()->tabla('inasistencias')->set_cursor($id);
        return $this->get_relacion()->tabla('inasistencias')->get();
    }
    
    function agregar_licencias_trabajadores($dato) {
        $id = $this->get_relacion()->tabla('inasistencias')->nueva_fila($dato);
		return $id;
    }
     function eliminar_licencias_trabajadores($id) {
        $this->$this->get_relacion()->tabla('inasistencias')->eliminar_fila($id);
    }
    function modificar_licencias_trabajadores($id, $dato, $mod) {
        $this->get_relacion()->tabla('inasistencias')->set_cursor($id);
        $this->get_relacion()->tabla('inasistencias')->set($dato);
    }
