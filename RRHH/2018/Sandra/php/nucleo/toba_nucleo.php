			...
			if (toba::memoria()->validar_pedido_pagina($frm)  === false) {
				...
				toba::memoria()->fijar_csrf_token(true);			
                            if (empty($_FILES) && empty($_POST)) {
                                throw new toba_error_usuario('Detectamos un pedido incompleto, esto puede deberse a que el sistema no le haya informado el limite para la subida de archivos o usted decidió hacer caso omiso de la advertencia, por favor contacte al irresponsable');
                            } else {			
