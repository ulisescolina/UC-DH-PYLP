<?php
class ci_asignaciones_familiares extends nominas_ci
{
    ...
    function get_datos($id) {
        $this->get_relacion()->tabla('asignaciones_flia_trabajador')->set_cursor($id);
        return $this->get_relacion()->tabla('asignaciones_flia_trabajador')->get();
    }
    
    function agregar_datos($dato) {
        $id = $this->get_relacion()->tabla('asignaciones_flia_trabajador')->nueva_fila($dato);
		return $id;
    }
     function eliminar_datos($id) {
        $this->$this->get_relacion()->tabla('asignaciones_flia_trabajador')->eliminar_fila($id);
    }
    function modificar_datos($id, $dato, $mod) {
        $this->get_relacion()->tabla('asignaciones_flia_trabajador')->set_cursor($id);
        $this->get_relacion()->tabla('asignaciones_flia_trabajador')->set($dato);
    }
