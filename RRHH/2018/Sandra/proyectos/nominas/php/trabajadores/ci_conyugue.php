<?php
class ci_conyugue extends nominas_ci
{
    ...
    function get_datos($id) {
        $this->get_relacion()->tabla('conyugue')->set_cursor($id);
        return $this->get_relacion()->tabla('conyugue')->get();
    }
    
    function agregar_datos($dato) {
        $id = $this->get_relacion()->tabla('conyugue')->nueva_fila($dato);
		return $id;
    }
     function eliminar_datos($id) {
        $this->$this->get_relacion()->tabla('conyugue')->eliminar_fila($id);
    }
    function modificar_datos($id, $dato, $mod) {
        $this->get_relacion()->tabla('conyugue')->set_cursor($id);
        $this->get_relacion()->tabla('conyugue')->set($dato);
    }
