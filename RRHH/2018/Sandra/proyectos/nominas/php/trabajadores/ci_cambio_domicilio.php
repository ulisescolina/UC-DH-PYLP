<?php
class ci_cambio_domicilio extends nominas_ci
{
    ...
    function get_datos($id) {
        $this->get_relacion()->tabla('domicilios')->set_cursor($id);
        return $this->get_relacion()->tabla('domicilios')->get();
    }
    
    function agregar_datos($dato) {
        $id = $this->get_relacion()->tabla('domicilios')->nueva_fila($dato);
		return $id;
    }
     function eliminar_datos($id) {
        $this->$this->get_relacion()->tabla('domicilios')->eliminar_fila($id);
    }
    function modificar_datos($id, $dato, $mod) {
        $this->get_relacion()->tabla('domicilios')->set_cursor($id);
        $this->get_relacion()->tabla('domicilios')->set($dato);
    }
