...
<?php
    ...
    { // Yes
        ...
        {
            $hash_values['title'] = htmlentities(utf8_e_seguro($objectName), ENT_XML1 | ENT_SUBSTITUTE, 'UTF-8');
        }
        if (!isset ($hash_values['summary']))
        {
            $hash_values['summary'] = htmlentities(utf8_e_seguro($objectName), ENT_XML1 | ENT_SUBSTITUTE, 'UTF-8');
        }
